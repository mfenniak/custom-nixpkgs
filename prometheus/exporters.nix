...
let
  ...
  cfg = config.services.prometheus-custom.exporters;
...
in
{
  ...
  options.services.prometheus-custom.exporters = mkOption {
    type = types.submodule {
  ...
  #   services.prometheus2.exporters.minio.minioAddress  = mkDefault "http://localhost:9000";
  #   services.prometheus2.exporters.minio.minioAccessKey = mkDefault config.services.minio.accessKey;
  #   services.prometheus2.exporters.minio.minioAccessSecret = mkDefault config.services.minio.secretKey;
  # })]
  # ++ [(mkIf config.services.prometheus2.exporters.rtl_433.enable {
  #   hardware.rtl-sdr.enable = mkDefault true;
  # })]
  # ++ [(mkIf config.services.postfix.enable {
  #   services.prometheus2.exporters.postfix.group = mkDefault config.services.postfix.setgidGroup;
  # })]
